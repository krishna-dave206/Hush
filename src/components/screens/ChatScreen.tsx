...
export const ChatScreen: React.FC<{
  ...
  const handleReveal = () => {
    ...
    const revealMsg: Message = {
      ...
      senderId: user!.id,
      senderHandle: user!.handle,
      text: "I've revealed my meetup location!",
      timestamp: new Date().toISOString(),
        ...
        <DialogContent className="bg-zinc-900 border-red-500/20 rounded-[32px] max-w-[90vw] mx-auto sm:max-w-md">
          <DialogHeader className="flex flex-col items-center text-center space-y-4">
            ...
            <DialogDescription className="text-zinc-400 text-base">
              This will instantly end the chat, block this user for the
              session, and clear your presence from the venue.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isRevealOpen} onOpenChange={setIsRevealOpen}>
        <DialogContent className="bg-zinc-900 border-white/10 rounded-[32px] max-w-[90vw] mx-auto sm:max-w-md">
          <DialogHeader className="flex flex-col items-center text-center space-y-4">
            ...
            <DialogDescription className="text-zinc-400 text-base">
              This will show your table number and meetup spot to this
              user. Only reveal if you feel safe meeting.
            </DialogDescription>
          </DialogHeader>
